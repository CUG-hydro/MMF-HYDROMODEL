...
# message(STATUS "NetCDF_F90_INCLUDEDIR: ${NetCDF_C_INCLUDEDIR} ${NetCDF_F90_INCLUDEDIR}")
# message(STATUS "NetCDF_F90_LIBRARIES: ${NetCDF_F90_LIBRARIES}")
# message(STATUS "NetCDF_HAS_PARALLEL: ${NetCDF_HAS_PARALLEL}")

link_directories(
  "/opt/netcdf_v4.9.2_openmpi/lib"
